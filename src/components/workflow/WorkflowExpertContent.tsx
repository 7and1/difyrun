...
export function WorkflowExpertContent({
  ...
  const complexityInfo = {
    simple: {
      ...
      description:
        "Great for learning Dify basics. Easy to understand and modify.",
    ...
    moderate: {
      ...
      description:
        "Balanced complexity. Good for production use with some Dify experience.",
      importTime: "15-30 minutes to configure fully",
      customizationLevel:
        "Moderate effort — may need to understand node connections",
    },
    complex: {
      label: "Advanced",
      color: "text-orange-600",
      description:
        "Production-ready template. Best for experienced Dify users.",
      ...
      <div className="space-y-8">
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Getting &quot;{workflowName}&quot; running in your Dify instance
              ...
              <ol className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-muted-foreground">
                    ...
                    using the button above, or copy the code to your clipboard.
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-blue-500 text-white text-xs font-bold shrink-0">
                  ...
                  <div className="text-sm text-muted-foreground">
                    ...
                    and click &quot;Import DSL&quot; in the upper right corner
                    of your workspace.
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-muted-foreground">
                    <strong className="text-foreground">Upload or paste</strong>{" "}
                    — Dify accepts both file uploads and direct YAML paste.
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-blue-500 text-white text-xs font-bold shrink-0">
                  ...
                  <div className="text-sm text-muted-foreground">
                    ...
                    — Update API keys, knowledge bases, or external tools as
                    needed.
                  </div>
                </li>
              </ol>
              ...
              {(hasKnowledgeBase || hasToolNodes) && (
                <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/20">
                  ...
                  <ul className="text-xs text-muted-foreground space-y-1">
                    {hasKnowledgeBase && (
                      <li>
                        • This workflow uses a Knowledge Base — you&apos;ll need
                        to connect your own documents
                      </li>
                    )}
                    {hasToolNodes && (
                      <li>
                        • Contains external tool nodes — configure API keys or
                        MCP connections
                      </li>
                    )}
                  </ul>
        ...
        <div className="bg-background rounded-2xl p-6 lg:p-8 border">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            <p className="text-muted-foreground">
              Templates are starting points, not final products. Here&apos;s how
              to make this workflow truly yours:
            </p>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 not-prose mt-4">
              <div className="p-4 rounded-lg bg-muted/50">
                ...
                <p className="text-xs text-muted-foreground">
                  LLM node prompts are the easiest to customize. Adjust tone,
                  add context, or change the output format without touching the
                  workflow structure.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-muted/50">
                ...
                <p className="text-xs text-muted-foreground">
                  Run the workflow as-is first. Understanding how it works makes
                  modifications much easier and reduces debugging time.
                </p>
              </div>

              <div className="p-4 rounded-lg bg-muted/50">
                <h4 className="font-medium text-sm mb-2">
                  Branch, Don&apos;t Replace
                </h4>
                <p className="text-xs text-muted-foreground">
                  Keep the original template and create a copy for
                  modifications. This way you always have a working reference.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-muted/50">
                ...
                <p className="text-xs text-muted-foreground">
                  When adding nodes, make sure variable references still work.
                  Dify&apos;s visual editor shows broken connections clearly.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-muted/50">
                ...
                <p className="text-xs text-muted-foreground">
                  Most workflows work with different LLMs. Start with a cheaper
                  model for testing, then upgrade to GPT-4 or Claude for
                  production.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-muted/50">
                ...
                <p className="text-xs text-muted-foreground">
                  The real power comes from connecting your own data sources —
                  documents, APIs, or databases that make the workflow uniquely
                  valuable.
                </p>
              </div>
            </div>
