...
export async function POST(request: NextRequest) {
  try {
    ...
    let content =
      data.choices?.[0]?.message?.content || getFallbackResponse(prompt);
    ...
    return NextResponse.json({
      ...
      message: {
        ...
        role: "assistant",
        content:
          "I'm having trouble connecting right now. Here's a quick tip: To import a workflow, download the DSL file from any template page and upload it to your Dify Studio!",
      },
