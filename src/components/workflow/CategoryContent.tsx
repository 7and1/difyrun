...
anymore — it pulls from real documents you've uploaded.`,
    ...
    useCases: [
      { title: 'Internal Knowledge Base', description: 'Let employees ask questions about company policies, procedures, and documentation' },
      { title: 'Customer Support Bot', description: 'Answer customer questions using your product documentation and FAQ' },
      { title: 'Research Assistant', description: 'Query hundreds of papers or reports and get synthesized answers' },
      { title: 'Legal Document Analysis', description: 'Find relevant clauses and precedents across contract libraries' }
    ],
    tips: [
...
refined keywords, and then synthesize an answer. All autonomously.`,
    ...
    useCases: [
      { title: 'Deep Research Agent', description: 'Searches multiple sources, synthesizes findings, and produces reports' },
      { title: 'Code Review Agent', description: 'Analyzes code, runs tests, and suggests improvements' },
      { title: 'Sales Lead Qualifier', description: 'Researches companies, scores leads, and drafts personalized outreach' },
      { title: 'Content Creator', description: 'Researches topics, outlines articles, and drafts content with citations' }
    ],
    tips: [
...
unlocks access to thousands of tools — including Zapier's 7,000+ app integrations.`,
    ...
    useCases: [
      { title: 'Zapier Integration', description: 'Connect to CRM, email, calendar, and thousands of other apps' },
      { title: 'Database Access', description: 'Query PostgreSQL, MySQL, or MongoDB directly from workflows' },
      { title: 'File System Tools', description: 'Read, write, and manipulate files on your server' },
      { title: 'Custom API Bridge', description: 'Expose any REST API as an MCP tool for AI consumption' }
    ],
    tips: [
...
document lands in this folder, extract key data and update the spreadsheet.`,
    ...
    useCases: [
      { title: 'Content Generation', description: 'Generate social posts, email drafts, or product descriptions at scale' },
      { title: 'Data Processing', description: 'Extract, transform, and load data with AI assistance' },
      { title: 'Document Handling', description: 'Summarize, categorize, or translate documents automatically' },
      { title: 'Monitoring & Alerts', description: 'Watch data sources and trigger actions based on conditions' }
    ],
    tips: [
...
makes decisions.`,
    ...
    useCases: [
      { title: 'Customer Support', description: 'Answer FAQs, troubleshoot issues, and escalate when needed' },
      { title: 'Lead Qualification', description: 'Engage website visitors and collect information before sales handoff' },
      { title: 'Internal IT Help Desk', description: 'Reset passwords, answer policy questions, submit tickets' },
      { title: 'Product Recommendations', description: 'Help customers find the right product based on their needs' }
    ],
    tips: [
...
direct user interaction.`,
    ...
    useCases: [
      { title: 'Text Enhancement API', description: 'Grammar correction, summarization, or translation as a service' },
      { title: 'Document Processing API', description: 'Extract data from invoices, receipts, or contracts' },
      { title: 'Content Moderation', description: 'Check user-generated content before publishing' },
      { title: 'Recommendation Engine', description: 'Get personalized suggestions based on user data' }
    ],
    tips: [
...
previews so you can understand the structure before downloading.`,
  ...
  useCases: [
    { title: 'Quick Prototyping', description: 'Start with a working template and modify to fit your needs' },
    { title: 'Learning Dify', description: 'Study well-designed workflows to understand Dify patterns' },
    { title: 'Production Deployment', description: 'Use battle-tested templates as a foundation for production' }
  ],
  tips: [
...
export function CategoryContent({ categoryId, categoryName }: CategoryContentProps) {
      ...
      <div className="space-y-10">
        ...
        <div className="max-w-3xl">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold">Understanding {categoryName} Workflows</h2>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="bg-background rounded-xl border p-6">
            <h3 className="text-lg font-semibold mb-4">Why Use {categoryName} Templates?</h3>
        ...
        <div className="bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10 rounded-2xl p-6 lg:p-8 border">
          <h3 className="text-xl font-semibold mb-4">Pro Tips for {categoryName}</h3>
        ...
        <div className="text-center py-6">
          <p className="text-muted-foreground mb-4">
            Browse the templates above and find the perfect starting point for your project.
            Every template is free to download and customize.
          </p>
          <a
